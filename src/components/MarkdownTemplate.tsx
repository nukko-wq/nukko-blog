    ...
    if (domNode.type === 'tag') {
      ...
      if (domNode.name === 'code') {
        if (domNode.parent.name === 'pre') {
          const highlightCode = highlight.highlightAuto(domToReact(domNode.children) as string, languageSubset).value
          return (
          ...
          return <ChakraCode {...code.props}>{domToReact(domNode.children, options)}</ChakraCode>
        }
      }
    }
  },
